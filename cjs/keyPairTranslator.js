...
var keyPairTranslationMap = require('./keyPairTranslationMap.js');
...
async function toMultikey({keyPair}) {
  const translationResult = keyPairTranslationMap.keyPairTranslationMap.get(keyPair.type);
